...
func getFuncChecker(valueToCheck interface{}) contains.FuncChecker {
...
func Test_funcContains_Contains(t *testing.T) {
	type fields struct {
		funcChecker contains.FuncChecker
	}
	type args struct {
		value interface{}
	}
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			f := contains.NewFunc(tt.fields.funcChecker)
...
func Test_setContains_Contains(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			s := contains.NewSet(tt.fields.set)
